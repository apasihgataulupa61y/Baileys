...
export declare const isJidHostedPnUser: (jid: string | undefined) => boolean | undefined;
/** is the jid a hosted LID */
export declare const isJidHostedLidUser: (jid: string | undefined) => boolean | undefined;
